...
with col1:
    st.image(Image.open("G:\\PROJECT\\project_4-AIRBNB ANALYSIS\\3.jpg"), width=75)
with col2:
...
if select == "Home":
    ...
    with col2:
        st.write("---")
        st.image(Image.open("G:\\PROJECT\\project_4-AIRBNB ANALYSIS\\1.jpg"), width=500)
        st.write("---")
        st.image(Image.open("G:\\PROJECT\\project_4-AIRBNB ANALYSIS\\2.webp"), width=500)
...
if select == "Data Exploration":
    ...
    with tab6:
        ...
        st.write("---")
        st.image(Image.open("G:\\PROJECT\\project_4-AIRBNB ANALYSIS\\powerbi.jpg"), width=1000)
        st.write("---")

        st.header("URL Link")
        st.markdown("- [Click to view power bi Dashboard](https://app.powerbi.com/groups/me/reports/ba2a8905-fea0-43d4-b542-008ad0a67664/ReportSection?experience=power-bipowerbi link)")
        st.write("---")
